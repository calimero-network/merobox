...
| `node_identity` | — | Who this node is: `accountId`, `deviceId`, `publicKey`, `accountRootPublicKey`, `deviceAgreementKey`, `accountNamespaceId`, `holdsAccountRoot`, `deviceCertified`. Takes no namespace — none of it varies by one. |

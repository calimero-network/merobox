/* merobox Architecture — Shared Navigation + Full-text Search */
(function () {
  'use strict';
  ...
  const NAV = [
    ...
    { label: 'System Overview', href: 'system-overview.html', dot: '#58a6ff' },
    { section: 'Core Components' },
    { label: 'Workflow Engine', href: 'workflow-engine.html', dot: '#3fb950' },
    { label: 'Node Management', href: 'node-management.html', dot: '#a371f7' },
    { label: 'Remote Nodes', href: 'remote-nodes.html', dot: '#f778ba' },
    { label: 'NEAR Integration', href: 'near-integration.html', dot: '#f0883e' },
    { section: 'Reference' },
    { label: 'Workflow YAML', href: 'workflow-yaml.html', dot: '#f0883e' },
    { label: 'CLI Reference', href: 'cli-reference.html', dot: '#39d0d8' },
    { label: 'Error Handling', href: 'error-handling.html', dot: '#f85149' },
    { section: 'Guides' },
    { label: 'Testing', href: 'testing.html', dot: '#a5ff11' },
    { label: 'Troubleshooting', href: 'troubleshooting.html', dot: '#e3b341' },
    { label: 'Glossary', href: 'glossary.html', dot: '#39d0d8' },
  ];
  ...
  function buildSidebar() {
    ...
    sb.innerHTML = `
      <div class="sidebar-logo">
        <div class="sidebar-logo-inner">
          ...
          <div class="sidebar-logo-text">
            <strong>Calimero <em>merobox</em></strong>
      ...
      <div class="sidebar-footer">
        ...
        <div class="sidebar-footer-links">
          <a href="https://github.com/calimero-network" target="_blank" rel="noopener" title="GitHub">
          ...
          <a href="https://calimero.network" target="_blank" rel="noopener" title="Website">
          ...
          <a href="https://x.com/CalimeroNetwork" target="_blank" rel="noopener" title="X / Twitter">
          ...
          <a href="https://docs.calimero.network" target="_blank" rel="noopener" title="Docs">
    ...
    btn.onclick = () => {
      ...
      btn.innerHTML = open ? '<span class="menu-toggle-icon">&#10005;</span>' : '<span class="menu-toggle-icon">&#9776;</span>';
  ...
  function searchDocs(query, index) {
    ...
    for (const page of index) {
      ...
      if (titleMatch || headingMatch || excerpt) {
        const score = (titleMatch ? 2 : 0) + (headingMatch ? 1 : 0) + (excerpt ? 0.5 : 0);
        results.push({ ...page, excerpt, titleMatch, score });
      }
    }
  ...
  function renderResults(results, query) {
    ...
    if (!query.trim()) {
      el.innerHTML = '<p class="search-hint">Type to search across all documentation…</p>';
      selectedIdx = -1;
      return;
    }
    if (!results.length) {
